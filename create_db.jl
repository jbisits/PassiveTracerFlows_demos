...
begin
	...
	local_cats_eye = LocalResource(cats_eye, :autoplay => "", :loop => "", :width => 800, :height => 600)
end

# ╔═╡ 2090be93-dc9e-4f1b-a0ef-b337f556a32d
begin
	avd_diff_cell = PlutoRunner.currently_running_cell_id[] |> string
	local_adv_diff = LocalResource(adv_diff, :autoplay => "", :loop => "", :width => 800, :height => 600)
end

# ╔═╡ 8f5a8658-d2cd-4e13-8423-3217c616ca44
begin
	turb_ad_cell = PlutoRunner.currently_running_cell_id[] |> string
	local_turb_ad = LocalResource(turb_ad, :autoplay => "", :loop => "", :width => 800, :height => 600)
end
